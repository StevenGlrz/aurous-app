...
public class AboutFrame {
	...
	private void initialize() {
		...
		aboutLabel = new JLabel(
				"<html><center>Project Poptart is maintained by one mentally unstable guy with way too much ambition and a habit of premature optimization.<br>If you're interested in helping out check out the links below. </center></html>");
		...
		blogButton.addActionListener(e -> {
			try {
				Utils.openURL(new URL("http://blog.poptart.me/"));
		...
		donateButton.addActionListener(e -> {
			try {
				Utils.openURL(new URL("http://blog.poptart.me/donate"));
			} catch (final Exception e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
			}
				...
				.addActionListener(e -> {
					try {
						Utils.openURL(new URL(
								"https://github.com/Codeusa/poptart-app"));
					} catch (final Exception e1) {
						// TODO Auto-generated catch block
				e1.printStackTrace();
			}
		...
		frmAbout.setLocationRelativeTo(PopTartFrame.jfxPanel);
	}
}
